  ...
  return (
    <div className="bg-gradient-to-t from-[var(--neutral-10)] via-[var(--neutral-10)] to-transparent p-3 py-7 md:p-6 pt-2">
      ...
      {isConversationBlocked ? (
        <div className="flex flex-col items-center gap-3 rounded-[6px] border border-[var(--neutral-30)] bg-[var(--neutral-20)] p-4 text-center">
          <p className="text-sm text-[var(--neutral-60)]">
            {conversationSummary || 'Conversation reached its limit.'}
          </p>
          <button
            onClick={handleContinueConversation}
            className="rounded-lg bg-[var(--primary-main)] px-4 py-2 text-sm text-white hover:bg-[var(--primary-hover)]"
          >
        ...
        <div className="flex items-center gap-2 rounded-[6px] border border-[var(--neutral-30)] bg-[var(--neutral-20)] px-3 py-2">
          ...
          <textarea
            ...
            disabled={isSubmitting || isConversationBlocked}
          />
